...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_maquette" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e8bb7fcb#;
   pragma Export (C, u00001, "maquetteB");
   ...
   u00105 : constant Version_32 := 16#0936cab5#;
   pragma Export (C, u00105, "system__memoryB");
   u00106 : constant Version_32 := 16#e96a4b1e#;
